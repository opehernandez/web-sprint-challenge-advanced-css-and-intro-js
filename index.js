...
let getArtistByIndex = (arr, index) => `the artist at index ${index} is ${arr[index].name}`;
...
let removeArtist = (arr, index) => {       // <----------------- Used arrow function to practice
  arr.splice(index, 1);
  return arr.length;
}
